// From https://github.com/haroonob/d3js-gauge-chart/blob/master/gauge.js
...
function Gauge(placeholderName, configuration)
{
	...
	this.configure = function(configuration)
	{
		...
		//this.config.majorTicks = configuration.majorTicks;
		//this.config.minorTicks = configuration.minorTicks;
	...
	{
                //this.Logger.info("%s: %s", arguments.callee.name, "Starting render ...");
		...
		this.redraw(this.config.min, 0);
                //this.Logger.info("%s: %s", arguments.callee.name, "Ending render ...");
	}
