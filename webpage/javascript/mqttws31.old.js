...
//    	    	break;
   ...
   ClientImpl.prototype.getTraceLog = function () {
    ...
    ClientImpl.prototype._on_socket_message = function (event) {
        ...
        try {
console.log("wireMessage: %d", wireMessage.type);
        	switch(wireMessage.type) {
            case MESSAGE_TYPE.CONNACK:
console.log("CONNACK");
            ...
            case MESSAGE_TYPE.PUBLISH:
console.log("PUBLISH: %d", wireMessage.type);
...
console.log("Error: %d", wireMessage.type);
        	this._disconnected(ERROR.INTERNAL_ERROR.code , format(ERROR.INTERNAL_ERROR, [error.message]));
        	return;
        }
    };
...
console.log("QOS: %d", wireMessage.payloadMessage.qos);
...
console.log("_receiveMessage finished");
        }
    };
